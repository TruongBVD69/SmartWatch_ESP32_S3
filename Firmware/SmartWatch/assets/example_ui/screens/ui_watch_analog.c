...
lv_obj_t * ui_battery_group1 = NULL;
...
lv_obj_t * ui_weather_group_5 = NULL;
lv_obj_t * ui_degree_7 = NULL;
lv_obj_t * ui_cloud_fog_3 = NULL;
lv_obj_t * ui_step_group2 = NULL;
lv_obj_t * ui_daily_mission_group1 = NULL;
lv_obj_t * ui_button_top1 = NULL;
...
void ui_watch_analog_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_weather_group_5, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_cloud_fog_3 = lv_image_create(ui_weather_group_5);
    lv_image_set_src(ui_cloud_fog_3, &ui_img_weather_sun_cloud_png);
    ...
    lv_obj_remove_flag(ui_cloud_fog_3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
void ui_watch_analog_screen_destroy(void)
{
    ...
    ui_clock = NULL;
    ui_dots = NULL;
    ui_battery_group1 = NULL;
    ui_date_group2 = NULL;
    ui_day2 = NULL;
    ui_month2 = NULL;
    ui_year2 = NULL;
    ui_weather_title_group_2 = NULL;
    ui_weather_group_5 = NULL;
    ui_degree_7 = NULL;
    ui_cloud_fog_3 = NULL;
    ui_step_group2 = NULL;
    ui_daily_mission_group1 = NULL;
    ui_button_top1 = NULL;
